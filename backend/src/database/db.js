...
import { RUNWAY_LENGTHS } from './runwayLengths.js';
...
async function initDatabase() {
  ...
  const alterCols = [
    ...
    // Transfer (ferry/positioning) legs live in the weekly schedule but carry no
    // passengers and have no route — distance is stored directly on the row.
    `ALTER TABLE weekly_schedule ADD COLUMN IF NOT EXISTS is_transfer INTEGER DEFAULT 0`,
    `ALTER TABLE weekly_schedule ADD COLUMN IF NOT EXISTS distance_km REAL`,
  ...
  await safeQuery(`
    ...
    (64,'Boeing','747-8','Boeing 747-8',605,14320,920,3300,2200,0.044,0.055,'H',418000000,15,2,'Aircraft_Boeing_747-800.png')
    ON CONFLICT (id) DO NOTHING
  ...
  const fuelCorrections = [
    ["UPDATE aircraft_types SET min_runway_landing_m=1035, fuel_consumption_per_km=0.9  WHERE full_name='Saab 340'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1185, fuel_consumption_per_km=1.0  WHERE full_name='Dornier 328-100'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1380, fuel_consumption_per_km=0.9  WHERE full_name='Embraer EMB 120 Brasilia'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1000, fuel_consumption_per_km=0.8  WHERE full_name='British Aerospace Jetstream 41'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=966,  fuel_consumption_per_km=1.15 WHERE full_name='ATR 42'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1050, fuel_consumption_per_km=1.0  WHERE full_name='De Havilland DHC-8-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1300, fuel_consumption_per_km=1.5  WHERE full_name='Dornier 328 JET'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1268, fuel_consumption_per_km=1.2  WHERE full_name='De Havilland DHC-8-400'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1345, fuel_consumption_per_km=1.7  WHERE full_name='Embraer E175-E2'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=915,  fuel_consumption_per_km=1.5  WHERE full_name='ATR 72'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1259, fuel_consumption_per_km=1.8  WHERE full_name='Embraer E175'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1200, fuel_consumption_per_km=2.0  WHERE full_name='Embraer E190-E2'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1226, fuel_consumption_per_km=2.4  WHERE full_name='Embraer E190'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1220, fuel_consumption_per_km=2.3  WHERE full_name='Airbus A220-100'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1137, fuel_consumption_per_km=2.8  WHERE full_name='Avro RJ85'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1100, fuel_consumption_per_km=1.6  WHERE full_name='Embraer ERJ 135'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1290, fuel_consumption_per_km=2.1  WHERE full_name='Embraer E195-E2'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1470, fuel_consumption_per_km=2.9  WHERE full_name='Airbus A319'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1400, fuel_consumption_per_km=2.5  WHERE full_name='Airbus A319neo'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1300, fuel_consumption_per_km=2.6  WHERE full_name='Embraer E195'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1200, fuel_consumption_per_km=1.7  WHERE full_name='Embraer ERJ 140'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1400, fuel_consumption_per_km=1.8  WHERE full_name='Embraer ERJ 145'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1350, fuel_consumption_per_km=2.5  WHERE full_name='Airbus A220-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1420, fuel_consumption_per_km=2.8  WHERE full_name='Boeing 737-600'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1479, fuel_consumption_per_km=1.8  WHERE full_name='Bombardier CRJ-200'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1465, fuel_consumption_per_km=3.0  WHERE full_name='Airbus A320'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1400 WHERE full_name='Airbus A320neo'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1350, fuel_consumption_per_km=2.7  WHERE full_name='Airbus A318'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1500, fuel_consumption_per_km=2.6  WHERE full_name='Boeing 737-8 Max'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1710, fuel_consumption_per_km=3.3  WHERE full_name='Boeing 737-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1550, fuel_consumption_per_km=3.0  WHERE full_name='Boeing 737-500'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1630, fuel_consumption_per_km=3.0  WHERE full_name='Boeing 737-800'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1555, fuel_consumption_per_km=3.2  WHERE full_name='Boeing 757-200'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1551, fuel_consumption_per_km=2.1  WHERE full_name='Bombardier CRJ-700'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1530, fuel_consumption_per_km=3.3  WHERE full_name='Airbus A321'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1585, fuel_consumption_per_km=2.8  WHERE full_name='Airbus A321neo'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1650, fuel_consumption_per_km=3.3  WHERE full_name='Airbus A321 XLR'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1650, fuel_consumption_per_km=2.9  WHERE full_name='Boeing 737-10 Max'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1780, fuel_consumption_per_km=3.4  WHERE full_name='Boeing 737-400'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1596, fuel_consumption_per_km=2.3  WHERE full_name='Bombardier CRJ-900'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1800, fuel_consumption_per_km=5.4  WHERE full_name='Boeing 787-8'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1350, fuel_consumption_per_km=2.4  WHERE full_name='COMAC C909 (ARJ21)'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1700, fuel_consumption_per_km=3.4  WHERE full_name='Boeing 757-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1950, fuel_consumption_per_km=6.2  WHERE full_name='Boeing 787-9'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1300, fuel_consumption_per_km=2.3  WHERE full_name='Sukhoi Superjet 100'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1500, fuel_consumption_per_km=3.0  WHERE full_name='COMAC C919'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2050, fuel_consumption_per_km=6.5  WHERE full_name='Boeing 787-10'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1860, fuel_consumption_per_km=6.1  WHERE full_name='Airbus A350-900'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1850, fuel_consumption_per_km=6.8  WHERE full_name='Boeing 777-200'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1750, fuel_consumption_per_km=6.0  WHERE full_name='Airbus A330-200'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1830, fuel_consumption_per_km=6.3  WHERE full_name='Airbus A330-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1850, fuel_consumption_per_km=5.3  WHERE full_name='Airbus A330-800 Neo'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2000, fuel_consumption_per_km=5.6  WHERE full_name='Airbus A330-900 Neo'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2100, fuel_consumption_per_km=7.9  WHERE full_name='Boeing 777-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2000, fuel_consumption_per_km=6.5  WHERE full_name='Airbus A350-1000'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1900, fuel_consumption_per_km=12.2 WHERE full_name='Airbus A380'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2100, fuel_consumption_per_km=7.5  WHERE full_name='Airbus A340-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2200, fuel_consumption_per_km=8.3  WHERE full_name='Airbus A340-500'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2300, fuel_consumption_per_km=8.8  WHERE full_name='Airbus A340-600'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2150, fuel_consumption_per_km=10.5 WHERE full_name='Boeing 747-300'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2000, fuel_consumption_per_km=7.6  WHERE full_name='Boeing 777-200LR'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2150, fuel_consumption_per_km=11.7 WHERE full_name='Boeing 747-400'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=1860, fuel_consumption_per_km=7.2  WHERE full_name='Airbus A350-900 ULR'"],
    ["UPDATE aircraft_types SET min_runway_landing_m=2050 WHERE full_name='Boeing 747-8'"],
    ["UPDATE aircraft_types SET max_passengers=605 WHERE full_name='Boeing 747-8'"],
  ...
  const toflCorrections = [
    ...
    "UPDATE aircraft_types SET min_runway_takeoff_m=1560 WHERE full_name='Embraer EMB 120 Brasilia'",
    ...
    "UPDATE aircraft_types SET min_runway_takeoff_m=1905 WHERE full_name='Airbus A320neo'",
  ...
  // v2 (2026-05): per-year rate (kAge) lowered across the board so used aircraft
  // hold value better — the curve now bottoms ~54-65% of new price at the oldest
  // (was ~34-46%), giving a smooth "moderate discount" market with no floor clump.
  // kFh (per-flight-hour wear) is intentionally UNCHANGED: heavy frames still lose
  // more per hour, so age and hours both stay meaningful. Tiers (by hold-value):
  //   0.027 turboprops/smallest · 0.024 small RJs · 0.021 narrow-body ·
  //   0.017 wide-body twins · 0.014 flagships.
  const depreciationData = [
    [25,0.027,0.0000048],[26,0.027,0.0000048],[45,0.027,0.0000048],[48,0.027,0.0000048],
    [49,0.027,0.0000048],[50,0.027,0.0000048],[52,0.027,0.0000048],[58,0.027,0.0000048],
    [1,0.024,0.0000054],[2,0.024,0.0000054],[42,0.024,0.0000054],[43,0.024,0.0000054],
    [44,0.024,0.0000054],[46,0.024,0.0000054],[51,0.024,0.0000054],[53,0.024,0.0000054],
    [54,0.024,0.0000054],[55,0.024,0.0000054],
    [3,0.021,0.000006],[4,0.021,0.000006],[5,0.021,0.000006],[6,0.021,0.000006],
    [7,0.021,0.000006],[8,0.021,0.000006],[9,0.021,0.000006],[10,0.021,0.000006],
    [11,0.021,0.000006],[15,0.021,0.000006],[27,0.021,0.000006],[28,0.021,0.000006],
    [29,0.021,0.000006],[30,0.021,0.000006],[31,0.021,0.000006],[32,0.021,0.000006],
    [33,0.021,0.000006],[34,0.021,0.000006],[37,0.021,0.000006],[38,0.021,0.000006],
    [47,0.021,0.000006],[56,0.021,0.000006],[57,0.021,0.000006],[59,0.021,0.000006],
    [62,0.021,0.000006],[63,0.021,0.000006],
    [12,0.017,0.0000072],[16,0.017,0.0000072],[17,0.017,0.0000072],[18,0.017,0.0000072],
    [19,0.017,0.0000072],[20,0.017,0.0000072],[21,0.017,0.0000072],[22,0.017,0.0000072],
    [23,0.017,0.0000072],[24,0.017,0.0000072],[39,0.017,0.0000072],[60,0.017,0.0000072],
    [61,0.017,0.0000072],[40,0.017,0.0000072],[41,0.017,0.0000072],
    [13,0.014,0.000009],[14,0.014,0.000009],[35,0.014,0.000009],[36,0.014,0.000009],
    [64,0.014,0.000009],
  ];
  await runOnce('fix:depreciation-params-v2-moderate', async () => {
  ...
  // One-time used-market refresh: drop system-generated listings so they
  // regenerate with the new depreciation rates + repriced new_price_usd. Player
  // listings (seller_type='player') are untouched. The hourly fillUsedMarket()
  // scheduler repopulates emptied types within the hour.
  await runOnce('fix:used-market-refresh-reprice-2026-05', () =>
    pool.query("DELETE FROM used_aircraft_market WHERE seller_type = 'system'"));
